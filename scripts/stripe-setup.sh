...
# ----------------------------------------------------------------- price ----
# custom_unit_amount lets the buyer name the amount. Stripe caps the maximum,
# and the cap is not documented per-currency, so walk down until one sticks.

say "2/5  Price (customer-chosen amount, USD, min \$2)"
PRICE_ID=""
CHOSEN_MAX=""
for MAX in 99999999 9999999 999999; do
